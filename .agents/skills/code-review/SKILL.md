...
* **SOLID Principles:** 
  * *Single Responsibility:* Mỗi class/hàm chỉ làm đúng 1 nhiệm vụ duy nhất.
  * *Open/Closed:* Thiết kế code dễ mở rộng thêm tính năng mới mà không phải sửa trực tiếp mã nguồn cốt lõi cũ.
